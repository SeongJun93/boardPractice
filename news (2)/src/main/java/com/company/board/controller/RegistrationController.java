...
import com.company.board.service.AES256Util;
...
public class RegistrationController {
	...
	// 회원가입완료
		...
		public String insertRegistration(BoardVO vo) throws Exception {
			try {
				/*
				 * String inputPass = vo.getPassword(); String
				 * pwd=AES256Util.encrypt(inputPass); vo.setPassword(pwd);
				 */
	...
	public Map<String, Object> login(@RequestBody BoardVO vo, HttpSession session) throws Exception {
	 	Map<String, Object> resultMap = new HashMap<String, Object>();
		System.out.println("login시작");
		/* AES256Util.decrypt(vo.getPassword()); */
